    ...
    return (
      <div className="container-fluid">
...

        {
          (stats) ? (
            <div>
              <div class="container-fluid alert alert-success d-flex align-items-between justify-content-between" role="alert">
                <div>
                  Email Sent successfully
                </div>
                <button className="btn btn-link" onClick={setstats(false)}>
