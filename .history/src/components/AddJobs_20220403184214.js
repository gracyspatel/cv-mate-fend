    ...
    if (true)
    {
        return (
            <div className="container-fluid">
              <div style={{backgroundColor:"#000"}} className='row'>
                    <div style={{backgroundColor:"#000"}} className='col-lg-11 d-flex justify-content-end align-items-center'>
                        <button
                ...
                <div style={{backgroundColor:"#000"}} className='col-lg-11'>
